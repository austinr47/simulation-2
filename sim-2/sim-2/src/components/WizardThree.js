    ...
    render(){
        return(
            <div className="parent-div">
                ...
                <p>Address</p>
                    <input placeholder={`${this.props.addressOne}`} type="text" onChange={(event) => updateAddressOne(event.target.value)} />
                <p>City</p>
...
function mapStateToProps( state ) {
  ...
  export default connect( mapStateToProps, { updateAddressOne, updateCity, updateAddressTwo, updateAddressThree } )( WizardTHree );